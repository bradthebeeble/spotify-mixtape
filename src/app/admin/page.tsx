  ...
  return (
    <div className="flex min-h-dvh flex-col px-4 py-6 sm:px-6">
      ...
      <header className="mx-auto flex w-full max-w-lg items-center justify-between">
        ...
        <button onClick={handleLogout} className="text-sm text-spotify-light-gray transition-colors hover:text-white">
          Log out
        </button>
      </header>
      ...
      <main className="mx-auto mt-10 flex w-full max-w-lg flex-1 flex-col gap-6">
        <div className="animate-fade-in">
          <h1 className="text-2xl font-bold">Import a Playlist</h1>
          <p className="mt-1 text-sm text-spotify-light-gray">
            Paste a Spotify playlist URL to create a shareable mixtape experience.
          </p>
        </div>
